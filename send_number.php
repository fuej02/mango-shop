    ...
    <div class="container bg-2 img-responsive">
        <div class="row">
          ...
          <form method="post" action="">
            ...
            <br><br> -->
            <label for="password2" class="font-margin">&nbsp;&nbsp;&nbsp;&nbsp;驗證碼</label><br>
            <input name="password2" type="password" id="password2" placeholder="輸入驗證碼"  class="btn-style2">  
            <br><br>
            <a href="alter_passwd.html"><input name="button" type="submit" id="button" title="button" value="確認" class="btn btn-style img-responsive"></a>
            <br><br><br><br>
          </form>
            </div>
        </div>

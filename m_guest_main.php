...
$query_Recordset1 = "SELECT * FROM board ORDER BY boardid DESC";
...
<table width="914" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th width="78" height="50" align="center" valign="middle" bgcolor="#66FFFF">編號</th>
    <th width="281" height="50" align="center" valign="middle" bgcolor="#66FFFF">留言標題</th>
    <th width="288" height="50" align="center" valign="middle" bgcolor="#66FFFF">留言發布時間</th>
    <th width="159" height="50" align="center" valign="middle" bgcolor="#66FFFF">留言者</th>
    <th width="108" height="50" align="center" valign="middle" bgcolor="#66FFFF">編輯</th>
  </tr>
  <?php do { ?>
    <tr>
      <td height="50" align="center" valign="middle"><?php echo $row_Recordset1['boardid']; ?></td>
      <td height="50" align="center" valign="middle"><?php echo $row_Recordset1['boardsubject']; ?></td>
      <td height="50" align="center" valign="middle"><?php echo $row_Recordset1['boardtime']; ?></td>
      <td height="50" align="center" valign="middle"><?php echo $row_Recordset1['boardname']; ?></td>
      <td height="50" align="center" valign="middle"><a href="m_guest_md.php?boardid=<?php echo $row_Recordset1['boardid']; ?>">修改</a> / <a href="m_guest_del.php?boardid=<?php echo $row_Recordset1['boardid']; ?>">刪除</a></td>
    </tr>

    ...
    <div class="container bg-2 img-responsive">
        <div class="row">
          <form method="post" action="member_login.php">
            <h1 class="text-center title-font">會員登入</h1>
           ...
           <!-- <label for="password2" class="font-margin2">請在輸入一次密碼</label><br>
            ...
            <br><br>  -->
            <a href="#"><input name="button" type="submit" id="button" title="button" value="登入" class="btn btn-style img-responsive"></a>
            <br><br>
            <p  class="text-left"><a href="member_in.php">我要註冊</a><a href="forgot_number.php" class="text-right">忘記密碼</a></p>
            </div>
          </form>
        </div>
    </div>

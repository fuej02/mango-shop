...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL ="INSERT INTO member (`name`, tel, e_mail, `address`) VALUES ('$name', '$tel', '$e_mail', '$address')";

    $Result1 = mysqli_query($conn_sql, $insertSQL) or die('failed');


    $insertGoTo = "member_main.php";
    if (isset($_SERVER['QUERY_STRING'])) {
...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
  ...
  <p><label for="address">會員地址：<!-- <input name="a3" type="checkbox" id="a3" value="小吃"> -->

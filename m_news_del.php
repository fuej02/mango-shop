...
if ((isset($_POST['news_id'])) && ($_POST['news_id'] != "") && (isset($_POST['del']))) {
  //$deleteSQL = sprintf("DELETE FROM newscenter WHERE news_id=%s",
                       //GetSQLValueString($_POST['news_id'], "int"));
$news_id=$_POST['news_id'];
$deleteSQL = "DELETE FROM newscenter WHERE news_id='$news_id'";

 // mysql_select_db($database_conn_sql, $conn_sql);
  $Result1 = mysqli_query( $conn_sql,$deleteSQL) or die("failed");

  $deleteGoTo = "m_news_main.php";
...
<form name="form1" method="post" action="">
  <p>
    ...
    <input name="news_subject" type="text" id="news_subject" value="<?php echo $row_Recordset1['news_subject']; ?>" readonly>
  ...
  <p>
    ...
    <input name="news_date" type="text" id="news_date" value="<?php echo $row_Recordset1['news_date']; ?>" readonly>
  </p>
  <p>
    <label for="news_editor">發布人:</label>
    <input name="news_editor" type="text" id="news_editor" value="<?php echo $row_Recordset1['news_editor']; ?>" readonly>
  </p>
  <p>
    <label for="	news_content">發布內容:</label>
    <textarea name="	news_content" cols="50" rows="10" readonly id="	news_content"><?php echo $row_Recordset1['news_content']; ?></textarea>
  </p>
  <p>

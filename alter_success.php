...
<body class="bg-img">
 ...
 <!-- <div style="height: 55vh;"> -->
    ...
    <div class="container bg-2 img-responsive">
        <div class="row">
            <br><br><br><br>
            <h1 class="text-center title-font">修改成功☑</h1>
            <br><br><br><br>
            ...
            <br><br> -->
            <a href="member.php"><input name="button" type="button" id="button" title="button" value="重新登入" class="btn btn-style img-responsive"></a>
            <br><br><br><br>
        </div>
        </div>
    </div>
